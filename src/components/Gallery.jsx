...
const s = {
  section: {
    ...
    padding: "var(--sz-space-8) var(--sz-gutter) var(--sz-space-9)",
  },
  head: {
    display: "flex",
    alignItems: "flex-end",
  ...
  h2: {
    ...
    fontSize: "var(--sz-display-md)",
    fontWeight: 500,
    letterSpacing: "var(--sz-track-tight)",
    lineHeight: 1,
    margin: 0,
    color: "var(--sz-paper)",
  },
  ...
  return (
    <section id="work" aria-label="Photography portfolio" style={s.section}>
      <div style={s.head}>
        <div>
          <div style={s.eyebrow}>
            Selected Work — {String(plates.length).padStart(2, "0")} plates
          </div>
