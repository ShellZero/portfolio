...
export const IconButton = forwardRef(function IconButton(
  ...
  const variants = {
    ...
    glass: {
      background: "var(--sz-veil-paper)",
      color: "var(--sz-text)",
      borderColor: "transparent",
      backdropFilter: "var(--sz-blur)",
      WebkitBackdropFilter: "var(--sz-blur)",
    },
  };
  ...
  return (
    <button
      ...
      style={{
        ...
        transition:
          "background var(--sz-dur) var(--sz-ease), color var(--sz-dur) var(--sz-ease), border-color var(--sz-dur) var(--sz-ease)",
