...
const s = {
  ...
  img:     { width: '100%', aspectRatio: '4 / 5', objectFit: 'cover', filter: 'var(--sz-img-filter)', borderRadius: 'var(--sz-radius-sm)', display: 'block' },
    ...
    <section id="bio" aria-label="Biography" style={s.section}>
      <div style={s.inner} className="sz-bio-inner">
        <figure style={s.figure}>
          ...
          <figcaption style={{ position: 'absolute', left: 12, bottom: 12, fontFamily: 'var(--sz-font-mono)', fontSize: 10, letterSpacing: 'var(--sz-track-wide)', textTransform: 'uppercase', color: '#fff', mixBlendMode: 'difference' }}>
            Self-portrait
          </figcaption>
        </figure>
        ...
        <div>
          ...
          <div style={s.facts}>
            ...
            <div style={s.fact}><span style={s.fk}>Medium</span><span style={s.fv}>35mm · Digital</span></div>
