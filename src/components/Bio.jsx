...
const s = {
  section: {
    ...
    color: "var(--sz-ink)",
    padding: "var(--sz-space-10) var(--sz-gutter)",
  },
  inner: {
    maxWidth: "var(--sz-maxw)",
    margin: "0 auto",
    display: "grid",
    ...
    <section id="bio" aria-label="Biography" style={s.section}>
      <div style={s.inner} className="sz-bio-inner">
        ...
        <div>
          ...
          <p style={s.lede}>
            Harsha Pamu is a street photographer based in Los Angeles, chasing the raw beauty of the
            street — minimalism, chaos, and striking silhouettes.
          </p>
          <p style={s.body}>
            His photography has earned a place in LA art shows and exhibitions across galleries in
            the city. Aside from photography he is a cook and a software engineer — and he remains
            committed to capturing the soul of the street, one frame at a time.
          </p>
          <div style={s.facts} className="sz-bio-facts">
            <div style={s.fact}>
              <span style={s.fk}>Based in</span>
              <span style={s.fv}>Los Angeles</span>
            </div>
            <div style={s.fact}>
              <span style={s.fk}>Medium</span>
              <span style={s.fv}>28mm · Digital</span>
            </div>
          ...
          <div style={{ marginTop: 40, display: "flex", gap: 14, flexWrap: "wrap" }}>
            <Button
              ...
              target="_blank"
              iconRight={<IconArrowUpRight size={15} />}
            >
              Follow @shellzero
            </Button>
          </div>
